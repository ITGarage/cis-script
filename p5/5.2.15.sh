...
check_command="sshd -T | grep clientaliveinterval && sshd -T | grep clientalivecountmax"
score_pattern=""
# TODO: default settings clientaliveinterval 0 clientalivecountmax 3 check pateern should look for -gt 0 param
call_action=""
