...
check_command="stat /etc/cron.daily/ | grep 'File:\|Access: ('"
score_pattern="stat /etc/cron.daily/ | grep 'File:\|Access: (0700/drwx------)  Uid: (    0/    root)   Gid: (    0/    root)'"

call_action="chown root:root /etc/cron.daily/ && chmod og-rwx /etc/cron.daily/"
